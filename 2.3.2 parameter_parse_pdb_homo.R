...
#meta_parameter_PDB_homo <- read_excel("data/meta_parameter_PDB_homo_2018_7_20.xlsx")
...
dir0 <- '/Users/luho/Documents/pdb file/Swiss model information_2018_7_20/pdb_homo'
...
pdb_homo_filter1 <- pdbHomoFilter(pdb_homo=meta_parameter_PDB_homo)
length(unique(pdb_homo_filter1$UniProtKB_ac))
